...
public class MyPageController {
    ...
    @PostMapping("/mypage/walking-complete/{id}")
    public String mypageWalkingComplete(Principal principal, @PathVariable Integer id){
        customUserService.reservationWalkingChange(principal, id);
        return "redirect:/mypage";
    }
